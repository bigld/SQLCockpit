...
****************************************************************************************************
    ...
    gc_splitter = NEW #(  parent     = gc_docking "cl_gui_container=>screen0 "gc_docking
                          rows       = 3
                          columns    = 1
                          shellstyle = cl_gui_container=>ws_visible + cl_gui_container=>ws_child ).
...
****************************************************************************************************
    ...
    CASE e_ucomm.
      ...
      WHEN c_saved_list_share. "cockpit-401
...
* separator
    ...
    CLEAR l_button.
    MOVE: 'SYMBOL_EXPORT'    TO l_button-function,
        icon_workflow_external_event TO l_button-icon,
        text-b42           TO l_button-quickinfo,
        cntb_btype_button  TO l_button-butn_type,
        space              TO l_button-disabled.
    APPEND l_button TO e_object->mt_toolbar.
