*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/CADAXO/SQLCVGRV
*   generation date: 11.04.2010 at 17:15:55 by user CADAXO
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/CADAXO/SQLCVGRV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/CADAXO/SQLCVGRV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /CADAXO/SQLCVGRV_EXTRACT
TOTAL = /CADAXO/SQLCVGRV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/CADAXO/SQLCVGRV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/CADAXO/SQLCVGRV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /CADAXO/SQLCVGRV_EXTRACT
TOTAL = /CADAXO/SQLCVGRV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/CADAXO/SQLCVGRV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/CADAXO/SQLCVGRV'
...
TOTAL = /CADAXO/SQLCVGRV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/CADAXO/SQLCVGRV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/CADAXO/SQLCVGRV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/CADAXO/SQLCVGRV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/CADAXO/SQLCVGRV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /CADAXO/SQLCVGRV_EXTRACT
TOTAL = /CADAXO/SQLCVGRV_TOTAL
