...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/CADAXO/SQLCTEMV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /CADAXO/SQLCTEMV_EXTRACT
TOTAL = /CADAXO/SQLCTEMV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/CADAXO/SQLCTEMV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/CADAXO/SQLCTEMV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /CADAXO/SQLCTEMV_EXTRACT
TOTAL = /CADAXO/SQLCTEMV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/CADAXO/SQLCTEMV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/CADAXO/SQLCTEMV'
...
TOTAL = /CADAXO/SQLCTEMV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/CADAXO/SQLCTEMV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/CADAXO/SQLCTEMV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/CADAXO/SQLCTEMV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/CADAXO/SQLCTEMV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /CADAXO/SQLCTEMV_EXTRACT
TOTAL = /CADAXO/SQLCTEMV_TOTAL
