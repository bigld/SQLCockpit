CLASS /cadaxo/cl_sqlc_temp_rep DEFINITION
  PUBLIC
  INHERITING FROM /cadaxo/cl_sqlc_template
  FINAL
  CREATE PUBLIC .

*"* public components of class /CADAXO/CL_SQLC_TEMP_REP
...
CLASS /cadaxo/cl_sqlc_temp_rep IMPLEMENTATION.
...
* set data
    CASE gr_parser->g_select_version. "$001
      WHEN gr_parser->c_select_version_1 OR gr_parser->c_select_version_0. "$001
        ...
        l_scheme_program = '/CADAXO/SQLC_SME1S'.
      ...
      WHEN OTHERS. "$001
        ...
        l_scheme_program = '/CADAXO/SQLC_SME2S'.
...
****************************************************************************************************
    ...
    IF gwa_report-devclass NE space AND gwa_report-devclass NE '$TMP'.

      pname-devclass = gwa_report-devclass.
